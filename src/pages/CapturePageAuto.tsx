...
import { ArrowLeft, RotateCcw, CheckCircle2, Loader2, Zap, AlertCircle } from 'lucide-react'
...
export function CapturePageAuto() {
  ...
  }, [isReady, isAnalyzing, isCompleted, currentThrowIndex, throws, calibration, setAnalyzing])
        ...
        <Card className={`${getStatusColor()} transition-colors`}>
          <CardContent className="p-6 text-center">
            ...
            {isReady && !isCompleted && !isAnalyzing && (
              <div className="mt-2">
                <p className="text-sm text-muted-foreground">
                  Effectuez votre lancer naturellement - La détection est automatique
                </p>
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              <ol className="space-y-2 list-decimal list-inside">
                ...
                <li>L'application détecte automatiquement le début et la fin</li>
              ...
              <div className="mt-4 p-3 bg-warning/10 border border-warning/20 rounded">
                <div className="flex gap-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    <strong>Important :</strong> Faites des gestes nets et complets. Évitez les faux mouvements.
                  </p>
                </div>
              </div>
            </CardContent>
