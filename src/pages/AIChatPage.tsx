    ...
    setMessages([
      {
        ...
        role: "assistant",
        content:
          "👋 Bonjour ! Je suis votre coach IA personnel. Posez-moi vos questions sur votre technique, votre entraînement ou vos performances !",
        timestamp: new Date(),
      },
    ]);
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          ...
          role: "assistant",
          content:
            "❌ Désolé, une erreur s'est produite. Vérifiez votre clé API et votre connexion.",
          timestamp: new Date(),
        },
      ]);
    } finally {
          ...
          <CardContent className="flex-1 overflow-y-auto p-4 space-y-4 scrollbar-hide">
            {messages.map((message) => (
              ...
              >
                ...
                {/* Message */}
                <div
                  className={`flex-1 max-w-[85%] sm:max-w-[80%] ${message.role === "user" ? "text-right" : "text-left"}`}
                >
                  <div
