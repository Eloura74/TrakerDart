        ...
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-bold">Plan d'Entraînement IA</h1>
            </div>
          </div>
          ...
          <Card className="md:col-span-1 border-primary/20 h-fit">
            ...
            <CardContent className="space-y-4">
              ...
              {(!sessions || sessions.length === 0) && (
                <p className="text-xs text-yellow-500">
                  ⚠️ Complétez quelques sessions pour des recommandations personnalisées
                </p>
              )}
            </CardContent>
          </Card>
            ...
            {!trainingPlan && !loading && (
              <Card className="border-primary/20">
                <CardContent className="flex flex-col items-center justify-center py-12">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Aucun plan généré</h3>
                  <p className="text-muted-foreground text-center max-w-md">
                    Définissez votre objectif et générez un plan d'entraînement personnalisé
                    basé sur vos performances actuelles.
                  </p>
                </CardContent>
              </Card>
            )}
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-3 bg-muted/50 rounded-lg">
                        ...
                        <p className="text-lg font-semibold">{trainingPlan.duration} jours</p>
                      </div>
                      <div className="p-3 bg-muted/50 rounded-lg">
                        <p className="text-sm text-muted-foreground mb-1">Semaines</p>
                        <p className="text-lg font-semibold">{trainingPlan.weeks.length}</p>
                      </div>
                    </div>

                    <div className="space-y-2">
                      <p className="text-sm font-medium">Niveau actuel</p>
                      <p className="text-sm text-muted-foreground">{trainingPlan.currentLevel}</p>
                    </div>

                    <div className="space-y-2">
                      <p className="text-sm font-medium">Niveau visé</p>
                      <p className="text-sm text-muted-foreground">{trainingPlan.targetLevel}</p>
                    </div>

                    <Badge variant="secondary" className="text-xs">
                      Généré le {new Date(trainingPlan.generatedAt).toLocaleDateString('fr-FR')}
                  ...
                  <Card key={week.weekNumber} className="border-primary/20">
                    ...
                    <CardContent className="space-y-4">
                      {week.sessions.map((session) => (
                        <div key={session.day} className="border border-border/50 rounded-lg p-4">
                          <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                <p className="font-medium">Jour {session.day}</p>
                                ...
                                <div className="flex items-start gap-2">
                                  ...
                                  <div className="flex-1">
                                    ...
                                    <div className="flex flex-wrap gap-2 text-xs">
                                      ...
                                      <Badge variant="outline">{exercise.restSeconds}s repos</Badge>
